# Stolen from Ptychodactyl program by Jacione on github
...
class Camera(ABC):
    ...
    def set_defaults(self):
        ...
        self.set_resolution(resolution=None)
...
class Mightex(Camera):
    ...
    def __init__(self, verbose=True):
        ...
        _dll = CDLL(f'{libs}/Mightex/SSClassic_USBCamera_SDK.dll') # CDLL is a c-to-python converter
