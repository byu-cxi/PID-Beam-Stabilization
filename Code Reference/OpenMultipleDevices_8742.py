...
strPathDllFolder = os.path.join(os.path.dirname (strCurrFile), "dll_folder")
...
if (nDeviceCount > 0) :
    ...
    for oDeviceKey in strDeviceKeys :
        ...
        if (deviceIO.Open (strDeviceKey)) :
            ...
            #print(cmdLib8742.IdentifyInstrument (strDeviceKey, strModel, strSerialNum, strFwVersion, strFwDate))
